            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw nav_icon"></i>Tagihan</a>
                        </li>
						<li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw nav_icon"></i>Pembayaran</a>
                        </li>
						<li>
                            <a href="<?= base_url()?>index.php/login/logout"><i class="fa fa-dashboard fa-fw nav_icon"></i>Logout</a>
                        </li>
